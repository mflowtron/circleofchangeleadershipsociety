...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 floating-header px-4 md:px-6 py-3 flex items-center justify-between" style={{ paddingTop: 'max(0.75rem, var(--safe-inset-top, env(safe-area-inset-top)))' }}>
